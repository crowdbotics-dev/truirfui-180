"""
Django settings for truirfui_180 project.
...
ROOT_URLCONF = 'truirfui_180.urls'
...
WSGI_APPLICATION = 'truirfui_180.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "truirfui_180 API",
    "DESCRIPTION": "API documentation for truirfui_180 App",
    "VERSION": "v1",
}
